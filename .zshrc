...
xterm|xterm-color)
    ...
    zstyle ':completion:*' matcher-list 'm:{a-z}={A-Z}' list-colors 'di=34' 'ln=35' 'so=32' 'ex=31' 'bd=46;34' 'cd=43;34'
    ;;
kterm-color)
    stty erase '^H'
    export LSCOLORS=exfxcxdxbxegedabagacad
...
jfbterm-color)
    ...
    zstyle ':completion:*' matcher-list 'm:{a-z}={A-Z}' list-colors 'di=;36;1' 'ln=;35;1' 'so=;32;1' 'ex=31;1' 'bd=46;34' 'cd=43;34'
    ;;
esac
